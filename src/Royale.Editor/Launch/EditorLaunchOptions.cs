...
public sealed record EditorLaunchOptions(string MapId, string? ScreenshotPath, int ScreenshotAfterFrames, bool ResetLayout)
{
    public static EditorLaunchOptions Default { get; } = new(ContentCatalog.DefaultMapId, null, 0, false);
    public static EditorLaunchOptions Parse(IReadOnlyList<string> args)
    {
        string map = ContentCatalog.DefaultMapId; string? screenshot = null; int frames = 0; bool reset = false;
        ...
        return new(map, screenshot, frames, reset);
    }
