...
{
    public static StaticMeshGeometry Create() => GeometryHolder.Value;
    ...
    private static class GeometryHolder
    {
        internal static readonly StaticMeshGeometry Value = new(Vertices, Indices);
    }
}
