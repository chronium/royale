...
public sealed class ViewportAndCameraTests
{
    ...
    [Fact] public void MovementOnlyAppliesWhileCaptured() { var c=new EditorCameraController(); Vector3 before=c.Camera.Position; var input=new DebugCameraInput(true,false,false,false,false,false,0,0,false); c.Move(input,1); Assert.Equal(before,c.Camera.Position); c.SetCaptured(true); c.Move(input,1); Assert.NotEqual(before,c.Camera.Position); }
